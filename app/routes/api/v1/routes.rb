...
# This module defines routes for the V1 API namespace related to routing information.
module Routes::API::V1::Routes
  ...
  # Registers routes under the '/v1/routes' path.
  # @param app [Roda] The main application instance.
  def self.register(app)
    app.hash_branch(:v1, 'routes') do |r|
      # GET request handler for '/v1/routes'.
  ...
  def self.handle_routes_request(from_stop_name, to_stop_name, datetime, interval)
    from_datetime, to_datetime = Routes::API::V1::Routes.parse_datetime_and_interval(datetime, interval.to_i)
