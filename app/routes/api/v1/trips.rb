...
module Routes::API::V1::Trips
  ...
  def self.register(app)
    # Handles requests for '/v1/trips'.
    app.hash_branch(:v1, 'trips') do |r|
      # Handles requests with a trip ID.
      r.on Integer do |id|
        # Route: GET /v1/trips/:trip_id
        ...
        # Route: GET /v1/trips/:trip_id/stops
        ...
        r.on 'stops' do
          r.get(params!: STOP_PARAMS) do |departure_stop_name, service_id, datetime|
            ...
            validation_result = Routes::API::V1::Trips.validate_params(departure_stop_name, service_id, datetime)

            if validation_result.success?
              result = Routes::API::V1::Trips.handle_stops_request(id, departure_stop_name, service_id, datetime)
